...
main_lat3 =44.5074;	
main_lon3 = -114.112;
EQT_Challis_AK=readtable('EQT_Challis_chalvel.csv'); %davenport  model

A_B_AK=[EQT_Challis_AK.Herr<=5&EQT_Challis_AK.Verr<=5];

EQT_Challis=readtable('challis_ak135_EQT.csv'); % gradient velocity model new depths


A_B=[EQT_Challis.Herr<=5 &EQT_Challis.Verr<=5];

USGS_Challis=readtable('challis_usgs.csv'); %USGS 2020 catalog
