EQT_Stanley=readtable('EQ_Catalogs/EQT_Stanley_Gradient.csv'); % local velocity model with new
% depths 
...
stations=readtable('Station_Data/BSU_Stations.csv');
USGS_mainshock=[44.465 -115.118];
Montana_mainshock=[44.401 -115.239];
Qfaults = shaperead('Shape_Files/QuaternaryFaults.shp', 'UseGeoCoords', true,'BoundingBox',[-115.8 44; -114.7 44.75]);
Qfaults2 = shaperead('Shape_Files/Qfaults_US_Database.shp', 'UseGeoCoords', true,'BoundingBox',[-115.8 44; -114.7 44.75]);
