clear all 
%%
Chal = readtable('EQ_Catalogs/EQT_Challis_Gradient.csv');
Stanl = readtable('EQ_Catalogs/EQt_Stanley_Gradient.csv');
sul = readtable('EQ_Catalogs/EQT_Sulphur_sulvel.csv');
sul_inl = readtable("EQ_Catalogs/inl_sulphur.csv");
chal_inl = readtable("EQ_Catalogs/inl_challis.csv");
stan_inl =load('P_S_Difference_Seisan/PICK_DATA/norhin-seisan.mat'); 
...
writetable(Stanl, 'EQ_Catalogs/EQT_Stanley_Gradient.csv','Delimiter',',')
type 'EQ_Catalogs/EQT_Stanley_Gradient.csv'
