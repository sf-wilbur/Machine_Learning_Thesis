...
title('Manual minus EQT time');
text(hist_x(1)-hist_x(1)*0.1, max(h1.Values)-max(h1.Values)*0.1,sprintf('\\mu = %0.4f [s]',mean_p));
text(hist_x(1)-hist_x(1)*0.1, max(h1.Values)-max(h1.Values)*0.15,sprintf('\\sigma = %0.2f [s]',std_p));
text(hist_x(1)-hist_x(1)*0.1, max(h1.Values)-max(h1.Values)*0.2,sprintf('MAD = %0.2f [s]',mad_p));
...
text(hist_x(1)-hist_x(1)*0.1, max(h1.Values)-max(h1.Values)*0.2,sprintf('MAD = %0.2f [s]',mad_s));
